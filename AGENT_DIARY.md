...
- Surface currently maps 128 callables, 18 callable policy/storage fields, 104 reachable package-owned types, and 329 fields; every field has a classification, abstraction concept, type hash, and executable evidence. Returned callable objects and type-only interface methods are included.
